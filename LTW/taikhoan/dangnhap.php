<?php session_start();
	...
	if (isset($_POST['loginbtn'])) {
		...
		$sql = "SELECT * FROM users WHERE username LIKE '$tmpusername' AND password LIKE '$tmppassword'";
	...
	<body>
		...
		<div class = "blockcontainer">
			...
			<form class ="form" action="#" method="POST">
				...
				<div class="input-group mb-3">
					<input type = "hidden" name = "url1" value = <?php if (isset($_POST['url'])){ echo $url;} else {echo "/LTW/index.php";} ?>>
					<button style = "margin:auto; width:100%" class="btn btn-outline-primary" type="submit" name="loginbtn">Đăng nhập</button>
				</div>
				<div class="input-group mb-3">
					<a style = "margin:auto; width:50%" class = "btn btn-outline-info" href = "/LTW/taikhoan/dangky.php">Đăng ký</a>
